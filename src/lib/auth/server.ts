...
// Vercel deployment hosts (production alias + preview deployment URLs).
const vercelHosts: string[] = [];
const vercelUrl = env("VERCEL_URL");
const vercelProd = env("VERCEL_PROJECT_PRODUCTION_URL");
if (vercelUrl) vercelHosts.push(vercelUrl);
if (vercelProd) vercelHosts.push(vercelProd);
// Always allow this project's known production domain.
vercelHosts.push("btbookinggrokv2.vercel.app", "btbookinggrokv2-me-7b04.vercel.app");
